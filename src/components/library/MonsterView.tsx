...
export const MonsterView = ({ content }: MonsterViewProps) => {
  ...
  return (
    <div className="space-y-6 font-crimson">
      <div>
        ...
        <p className="text-lg text-muted-foreground">{data.size} {data.type}, {data.alignment}</p>
      </div>
      ...
      {data.lore && (
        <>
          <Separator />
          <div>
            <h3 className="text-lg font-cinzel font-bold text-muted-foreground mb-2">Lore</h3>
